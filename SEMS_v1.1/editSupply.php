...
if (isset($_POST['update'])) {
    ...
    // Get previous quantity from `supply_list` table
    $sql = "SELECT qty FROM supply_list WHERE id = $user_id";
    ...
    if ($new_inv_qty < 0 ) {
        ...
        // UPDATE the qty in `supply_list` table if passed
        $sql = "UPDATE `supply_list` SET `operator_id` = '$operator_id', `part_no` = '$part_no', `qty` = '$quantity', `supply_date` = '$supply_date', `expiry_date` = '$expiry_date' WHERE `id`='$user_id'"; 
        if (mysqli_query($conn, $sql)) {
            echo "Record updated successfully in supply_list table";
        } else {
            echo "Error updating record: " . mysqli_error($conn);
        }
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime" id="supply_date" name="supply_date" class="form-control" style="color: black" value="<?php echo $row['supply_date']; ?>" required>
                                        ...
                                        <div class="modal-footer">
                                            <a href="supply-list.php"><button type="button" class="btn btn-default" data-bs-dismiss="modal" >Cancel</button></a>
