            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-white">Supplying History</h1>
                            <!-- Start small bg card -->
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Supplying list</li>
                            </ol>
                            <!-- Start big bg card -->
                            <div class="card">
                                <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered striped">
                                            ...
                                            <tbody>
                                            <?php 
                                                // populate each row of html table with data from table `supply_list` 
                                                $i = 1;
                                                $current_date = date('Y-m-d');
                                                $supplying = $conn->query("SELECT * FROM supply_list ORDER BY supply_date DESC");
                                                while($row=$supplying->fetch_assoc()):
                                            ?>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class=""><?php echo date("d/m/Y H:i:s",strtotime($row['supply_date'])) ?></td>
                                                    <td class=""><?php echo date("M/Y",strtotime($row['expiry_date'])) ?></td>
                                                    
                                                    <!-- <td class="text-center">
                                                        either editSupply or edit-supply IDK
                                                        <a class="btn btn-primary" href="edit-supply.php?id=<?php echo $row['id'] ?>">Edit</a>
                                                        <a class="btn btn-danger" href="deleteSupply.php?id=<?php echo $row['id']; ?>">Delete</a>									
                                                    </td> -->
                                                </tr>
                                            <?php endwhile; ?>
                                            </tbody>
